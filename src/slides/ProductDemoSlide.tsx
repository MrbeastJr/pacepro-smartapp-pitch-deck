        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-3 pt-2">
              {[
                { icon: MapPin, title: 'GPS-Verified Attendance', desc: 'Students must be within 50m radius to mark present. No proxies.' },
                ...
                >
                  <div className="p-2 rounded-lg flex-shrink-0" style={{ background: 'var(--gold-light)' }}>
                    <item.icon size={18} weight="duotone" color="var(--gold)" />
                  </div>
                  <div>
          ...
          >
            ...
            <div className="deck-card relative overflow-hidden" style={{ padding: '1.5rem' }}>
              {/* Session header */}
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-mono" style={{ color: 'var(--text-muted)' }}>WebSocket Active</span>
                </div>
              </div>
              ...
              <div className="mb-5">
                ...
                <h3 className="text-lg font-bold text-white">Micro Economics II</h3>
                <p className="text-xs" style={{ color: 'var(--text-muted)' }}>Prof. Adebayo · Faculty of Social Sciences</p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                {[
                  ...
                  <div key={i} className="text-center p-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--dark-border)' }}>
                    <s.icon size={16} weight="duotone" color="var(--gold)" className="mx-auto mb-1.5" />
                    <div className="text-lg font-black text-white">{s.val}</div>
                    <div className="text-[9px] uppercase tracking-widest font-bold" style={{ color: 'var(--text-muted)' }}>{s.label}</div>
                  </div>
                ))}
              </div>
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-[10px]" style={{ color: 'var(--text-muted)' }}>{student.id}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold uppercase bg-emerald-500/10 text-emerald-400">
                        <CheckCircle size={10} weight="fill" /> {student.status}
                      </div>
                      <p className="text-[9px] mt-0.5" style={{ color: 'var(--text-muted)' }}>{student.time}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
